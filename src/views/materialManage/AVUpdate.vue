<template lang="html">
  <section class="updateContainer" style="width: 400px;">
    <el-form :model="avUpdateForm">
      ...
      <el-form-item label="高度" :label-width="avUpdateWidth">
        <el-input v-model="avUpdateForm.encode_height" auto-complete="off" style="width:200px;"></el-input>
      </el-form-item>
      <el-form-item label="码率" :label-width="avUpdateWidth">
        <el-input v-model="avUpdateForm.encode_bit_rate" auto-complete="off" style="width:200px;"></el-input>
      </el-form-item>
    </el-form>
...
export default {
  ...
  methods: {
        ...
        .then((res) => {
          if (res.data.success) {
            ...
            this.avUpdateForm = {
              ...
              dynamicTags: [],
              encode_height: resource.encodeConf.videoHeight,
              encode_bit_rate: resource.encodeConf.videoBitRate,
    ...
    handleUpdate() {
      ...
      if (this.preImg != '../../../static/images/defaultPostVideoImg.png' && this.preImg != '../../../static/images/defaultPostAudioImg.png') {
