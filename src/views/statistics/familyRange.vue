        ...
        <el-row>
            <el-col :span='24' class='toolbar' style='padding-bottom: 0px;'>
                <el-form :inline='true' :model='filters'>
                    <el-form-item>
                        <el-select v-model="filters.date_range_id" style="width: 310px;" placeholder="请输入招生期查询" filterable clearable remote :remote-method="selDateRangeRemoteMethod" @change='changeRangeId' :loading='selDateRangeLoading'>
        ...
        <el-table :data="dataList" border  style="width: 100%" :row-class-name="tableRowClassName">
            <!-- <el-table-column type="expand">
                <template scope="props">
                    <el-table :data="groupPerList" border style="width: 100%" v-if='props.row.titleType == 2'>
                        ...
                        <el-table-column label="销售" width="120" align='center'>
                            ...
                            <el-table-column prop="recruitTarget" label="组排名" width="120" :formatter='showJudge'></el-table-column>
                            <el-table-column prop="recruitTarget" label="家族排名" width="120" :formatter='showJudge'></el-table-column>
                            <el-table-column prop="recruitTarget" label="总排名" width="120" :formatter='showJudge'></el-table-column>
                        </el-table-column>
                    </el-table>
                    <p v-else style="color:#658374;">家族下无法查看个人记录！</p>
                </template>
            </el-table-column> -->
...
export default {
	...
	methods: {
		...
		loadData() {
			...
			statisticsFamGroRecruitSale(para).then(res => {
					if (res.data.success) {
