...
<div id="root">
	...
	<el-table border :data="allData" highlight-current-row v-loading="initLoading" style="width: 100%;">
		...
		<el-table-column prop="dateRangeName" label="招生期" width="120" align='center' show-overflow-tooltip></el-table-column>

		<el-table-column prop="promoterNum" label="有效推广人数" width="100" align='center' :formatter="formatNumber"></el-table-column>
		<el-table-column prop="promoterWorthyNum" label="有招生推广人数" width="100" align='center' :formatter="formatNumber"></el-table-column>
		<el-table-column prop="participationRate" label="招生参与率" width="100" align='center'></el-table-column>

		<el-table-column prop="fishNum" label="日招生数量（见习）" width="120" align='center'  :formatter="formatNumber"></el-table-column>
		<el-table-column prop="newNum" label="日招生数量（新）" width="100" align='center'  :formatter="formatNumber"></el-table-column>
		<el-table-column prop="oldNum" label="日招生数量（老）" width="100" align='center' :formatter="formatNumber"></el-table-column>
		<el-table-column prop="dayTotal" label="日招生数量（总计）" width="120" align='center'  :formatter="formatNumber"></el-table-column>

		<el-table-column prop="targetFish" label="招生目标（见习）" width="100" align='center' :formatter="formatNumber"></el-table-column>
		<el-table-column prop="fishRangeNum" label="累计招生（见习）" width="100" align='center'  :formatter="formatNumber"></el-table-column>
		<el-table-column prop="targetNew" label="招生目标（新）" width="100" align='center' :formatter="formatNumber"></el-table-column>
		<el-table-column prop="newRangeNum" label="累计招生（新）" width="100" align='center'  :formatter="formatNumber"></el-table-column>
		<el-table-column prop="targetOld" label="招生目标（老）" width="100" align='center' :formatter="formatNumber"></el-table-column>
		<el-table-column prop="oldRangeNum" label="累计招生（老）" width="100" align='center' :formatter="formatNumber"></el-table-column>
		<el-table-column prop="targetTotal" label="招生目标（总计）" width="100" align='center' :formatter="formatNumber"></el-table-column>
		<el-table-column prop="rangeTotal" label="累计招生（总计）" width="100" align='center' :formatter="formatNumber"></el-table-column>
		<el-table-column prop="completionRate" label="完成率（总计）" width="100" align='center'></el-table-column>
		...
		<el-table-column prop="fishTrainingNum" label="日弱绑定（见习）" width="120" align='center'  :formatter="formatNumber"></el-table-column>
		<el-table-column prop="newTrainingNum" label="日弱绑定（新）" width="100" align='center'  :formatter="formatNumber"></el-table-column>
		<el-table-column prop="oldTrainingNum" label="日弱绑定（老）" width="100" align='center' :formatter="formatNumber"></el-table-column>
		<el-table-column prop="dayTrainingTotal" label="日弱绑定（总计）" width="120" align='center'  :formatter="formatNumber"></el-table-column>

		<el-table-column prop="fishTrainingRangeNum" label="累计弱绑定（见习）" width="120" align='center'  :formatter="formatNumber"></el-table-column>
		<el-table-column prop="newTrainingRangeNum" label="累计弱绑定（新）" width="120" align='center'  :formatter="formatNumber"></el-table-column>
		<el-table-column prop="oldTrainingRangeNum" label="累计弱绑定（老）" width="120" align='center' :formatter="formatNumber"></el-table-column>
		<el-table-column prop="rangeTrainingTotal" label="累计弱绑定（总计）" width="120" align='center'  :formatter="formatNumber"></el-table-column>
	</el-table>
...
export default {
	...
	methods: {
		...
		handleExport() {
			...
			this.$refs['oForm'].action = "/op/promoter/statistics/export/recruit" + params;
